...
public class EnergyUtil {
	...
	/**
	 * Gets all the connected energy acceptors, whether IC2-based or
	 * BuildCraft-based, surrounding a specific tile entity.
	 * 
	 * @param tileEntity
	 *            - center of tile entity
	 * @return TileEntity[] of connected acceptors
	 */
	public static TileEntity[] getConnectedEnergyRecivers(TileEntity tileEntity) {

		TileEntity[] acceptors = new TileEntity[] {
		...
		for (ForgeDirection orientation : ForgeDirection.VALID_DIRECTIONS) {
			...
			if (acceptor instanceof IStrictEnergyAcceptor || acceptor instanceof IEnergySink
					|| acceptor instanceof IPowerReceptor && !(acceptor instanceof IUniversalCable)
					&& AltEnergy.hooks.BuildCraftLoaded) {
	...
	public static TileEntity[] getConnectedCables(TileEntity tileEntity) {
		...
		TileEntity[] cables = new TileEntity[] {
				null, null, null, null, null, null
		};
