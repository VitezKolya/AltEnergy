...
public class ChunkProviderTerra implements IChunkProvider {
	...
	// TODO Stronghold stuff commented out
	...
	public void generateTerrain(int par1, int par2, byte[] par3ArrayOfByte) {
		...
		byte b3 = 17;
		int l = b0 + 1;
		biomesForGeneration = worldObj.getWorldChunkManager().getBiomesForGeneration(biomesForGeneration, par1 * 4 - 2,
				par2 * 4 - 2, k + 5, l + 5);
					...
					for (int l1 = 0; l1 < 8; ++l1) {
						...
						for (int i2 = 0; i2 < 4; ++i2) {
							...
							for (int k2 = 0; k2 < 4; ++k2) {
								if ((d16 += d15) > 0.0D) {
									par3ArrayOfByte[j2 += short1] = (byte) BlockIds.GRANITE;
								} else if (k1 * 8 + l1 < b2) {
	...
	private double[] initializeNoiseField(double[] par1ArrayOfDouble, int par2, int par3, int par4, int par5, int par6,
		...
		ChunkProviderEvent.InitNoiseField event = new ChunkProviderEvent.InitNoiseField(this, par1ArrayOfDouble, par2,
		...
		noise3 = noiseGen3.generateNoiseOctaves(noise3, par2, par3, par4, par5, par6, par7, d0 / 80.0D, d1 / 160.0D,
				d0 / 80.0D);
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
		...
		if (TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, flag, LAKE) && !flag
				&& rand.nextInt(4) == 0) {
	...
	public List getPossibleCreatures(EnumCreatureType par1EnumCreatureType, int par2, int par3, int par4) {
		...
		// BiomeGenBase.swampland && par1EnumCreatureType ==
	...
	public ChunkPosition findClosestStructure(World par1World, String par2Str, int par3, int par4, int par5) {
		...
		return null;
		// TODO Stronghold stuff commented out
		// return "Stronghold".equals(par2Str) && this.strongholdGenerator !=
		// null ? this.strongholdGenerator.getNearestInstance(par1World, par3,
		// par4, par5) : null;
	}
