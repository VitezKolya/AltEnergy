...
public class PacketTileWithItemUpdate extends PacketAE {
	...
	public void execute(INetworkManager manager, Player player) {
		...
		AltEnergy.proxy.handleTileWithItemPacket(x, y, z, ForgeDirection.getOrientation(orientation), state,
				customName, itemID, metaData, stackSize, color);
	}
}
