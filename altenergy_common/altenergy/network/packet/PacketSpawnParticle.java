...
public class PacketSpawnParticle extends PacketAE {
	...
	public PacketSpawnParticle(String particleName, double x, double y, double z, double velocityX, double velocityY,
			double velocityZ) {
	...
	public void exectute(INetworkManager manager, Player player) {
