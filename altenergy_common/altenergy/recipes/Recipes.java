...
public class Recipes {
	...
	public void init() {
		...
		// Grinder Recipes
		RecipeHandler.addGrinderRecipe(new ItemStack(ModBlocks.strangeCrystalOre, 1),
				new ItemStack(ModItems.gems, 2, 0));
		...
		RecipeHandler.addCrystalPurifierRecipe(new ItemStack(ModItems.dusts, 1, 14),
				new ItemStack(ModItems.dusts, 1, 8));
		RecipeHandler.addCrystalPurifierRecipe(new ItemStack(ModItems.dusts, 2, 16),
				new ItemStack(ModItems.dusts, 1, 8));
